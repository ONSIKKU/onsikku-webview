        ...
        <div className="mt-8 space-y-8">
          ...
          <div className="space-y-3">
            ...
            <input
              ...
              className="w-full appearance-none rounded-2xl border-2 border-gray-100 bg-gray-50 px-5 py-4 text-lg font-medium text-gray-900 shadow-sm outline-none transition-all focus:border-onsikku-dark-orange focus:bg-white focus:ring-1 focus:ring-onsikku-dark-orange"
            />
          </div>
